...
if(isset($_FILES['image'])){
   ...
   ?>
		...
		<div id="save"> 
		<img src="images/canvas/2.jpg" alt="Image Not Available" id="show" style="width:400px;height:400px;">
		
		<?php
		if(isset($_POST['submit'])){
			echo '<div>
			<img src="images/upload/canvas/canvas.jpeg" alt="Image Not Available" style="width: 250px;height: 280px;position: relative;top: -365px;left:41px">
			</div>';
		}
