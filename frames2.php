...
<body>
	...
	<div class="w3-contact" id="contact">
		...
		<!--<table align="center" width="80%">
			...
			<tr align="center">
				<td><img src="images/frames/2.png" alt="Image Not Available" style="width:250px;height:300px;"></td>
			</tr>
...
if(isset($_FILES['image'])){
   ...
   ?>
		...
		<div id="save"> 
		<img src="images/frames/2.png" alt="Image Not Available" id="show" style="width:350px;height:400px;">
		
		<?php
		if(isset($_POST['submit'])){
			echo '<div>
			<img src="images/upload/frames/fram.jpeg" alt="Image Not Available" style="width: 200px;height: 220px;position: relative;top: -305px;">
			</div>';
		}
  ...
  <img src="images/frames/2.png" id="mirror" class="canvas__mirror" />
</div>-->
