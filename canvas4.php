...
if(isset($_FILES['image'])){
   ...
   ?>
		...
		<div id="save"> 
		<img src="images/canvas/4.jpg" alt="Image Not Available" id="show" style="width:700px;height:500px;">
		
		<?php
		if(isset($_POST['submit'])){
			echo '<div>
			<img src="images/upload/canvas/canvas.jpeg" alt="Image Not Available" style="width: 355px;height: 290px;position: relative;top: -465px;right:5px">
			</div>';
		}
