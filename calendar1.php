...
if(isset($_FILES['image'])){
   ...
   ?>
		...
		<div id="save"> 
		<img src="images/calendar/1.png" alt="Image Not Available" id="show" style="width:500px;height:300px;">
		
		<?php
		if(isset($_POST['submit'])){
			echo '<div>
			<img src="images/upload/calendar/fram.jpeg" alt="Image Not Available" style="width: 240px;height: 300px;position: relative;top: -300px;right:129px">
			</div>';
		}
