...
$ptype = $_POST['typep'];
		...
		$target_dir = "images/upload/admin/";
		//$random = 'fream';
	...
	// if everything is ok, try to upload file
		...
		if (move_uploaded_file($tmp, "images/upload/admin/" . $user.".".$extension[1])) {
			function watermarkImage ($SourceFile, $WaterMarkText, $DestinationFile) { 
				...
				global $ptype;
								...
								if ($DestinationFile<>'') {
								   imagejpeg ($image_p, $DestinationFile, 10); //clearity set
								} else {
								...
								Include('connect.php');
								$sql1 = "INSERT INTO admin_gallary (images,image_copy,photo_type) VALUES ('$name','$name','$ptype')";
							...
							$SourceFile = 'images/upload/admin/'.$name;
							$DestinationFile = 'images/admin_stock_image/'.$name; 
   ...
   ?>
	...
	<div class="w3-contact" id="contact">
		...
		<h3 class="center">Upload a Stock Image</h3>
			...
			<tr align="center">
				<td>
							...
							<br>
							  ...
							  <input type="submit" value="Upload" name="stock_up"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
