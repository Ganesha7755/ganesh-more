...
<body>
				...
				<div class="collapse navbar-collapse navHeaderCollapse">
					...
					<div class="agileinfo-social-grids">
						...
						<ul>
							...
							<li><a href="calendar.php"><span>Calendars</span></a></li>
						</ul>
	...
	<div class="w3-contact" id="contact">
		...
		<!--<table align="center" width="80%">
			...
			<tr align="center">
				<td><img src="images/calendar/1.png" alt="Image Not Available" style="width:250px;height:300px;"></td>
			</tr>

			<tr align="center">
				<td><label></label>
							<br>
							<form action="calendar_action.php" method="post" enctype="multipart/form-data">
...
if(isset($_FILES['image'])){
	...
	if(isset($_POST["submit"])) {
		...
		$target_dir = "images/upload/calendar/";
		//$random = 'fream';
	...
	// if everything is ok, try to upload file
		...
		if (move_uploaded_file($tmp, "images/upload/calendar/" . $user.".".$extension[1])) {
   ...
   ?>
		...
		<div id="save"> 
		<img src="images/calendar/3.png" alt="Image Not Available" id="show" style="width:500px;height:300px;">
		
		<?php
		if(isset($_POST['submit'])){
			echo '<div>
			<img src="images/upload/calendar/fram.jpeg" alt="Image Not Available" style="width: 257px;height: 300px;position: relative;top: -300px;right:119px">
			</div>';
		}
  ...
  <img src="images/calendar/1.png" id="mirror" class="canvas__mirror" />
</div>-->
...
if(isset($_POST['payment']))
{
	...
	file_put_contents('images/upload/calendar/'."$rand".".png",$decode);
