...
<body>
	...
	<div class="w3-contact" id="contact">
		<div class="container contact1">
			<h3 class="center">Photographer Login</h3>
			<form action="photo_login_action.php" method="post" align="center">
				<div class="sect2">
					<div class="details1">
		
							<label>Email (Username) : &nbsp;&nbsp;&nbsp;
							<input type="email" style="width: 200px" name="photo_email" 
							placeholder="Eg. abcde@gmail.com" required></label>

							<label>Password : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="password" name="photo_pass" 
