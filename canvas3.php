...
if(isset($_FILES['image'])){
   ...
   ?>
		...
		<div id="save"> 
		<img src="images/canvas/3.jpg" alt="Image Not Available" id="show" style="width:400px;height:400px;">
		
		<?php
		if(isset($_POST['submit'])){
			echo '<div>
			<img src="images/upload/canvas/canvas.jpeg" alt="Image Not Available" style="width: 350px;height: 365px;position: relative;top: -390px;right:10px">
			</div>';
		}
