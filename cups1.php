...
<body>
	...
	<div class="w3-contact" id="contact">
		...
		<!--<table align="center" width="80%">
			...
			<tr align="center">
				<td><img src="images/cups/1.png" alt="Image Not Available" style="width:250px;height:300px;"></td>
			</tr>

			<tr align="center">
				<td><label></label>
							<br>
							<form action="cups_action.php" method="post" enctype="multipart/form-data">
...
if(isset($_FILES['image'])){
	...
	// if everything is ok, try to upload file
		...
		if (move_uploaded_file($tmp, "images/upload/" . $user.".".$extension[1])) {
   ...
   ?>
		...
		<div id="save"> 
		<img src="images/cups/g.jpg" alt="Image Not Available" id="show" style="width:250px;height:300px;">
		
		<?php
		if(isset($_POST['submit'])){
			echo '<div>
			<img src="images/upload/fram.jpeg" alt="Image Not Available" style="width: 183px;
			height: 148px;
			position: relative;
			top: -238px;
			left: 47px;">
  ...
  <img src="images/cups/1.png" id="mirror" class="canvas__mirror" />
</div>-->
...
if(isset($_POST['payment']))
{
	...
	file_put_contents('images/upload/'."$rand".".png",$decode);
