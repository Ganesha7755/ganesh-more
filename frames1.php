...
if(isset($_FILES['image'])){
   ...
   ?>
		...
		<div id="save"> 
		<img src="images/frames/1.png" alt="Image Not Available" id="show" style="width:250px;height:300px;">
		
		<?php
		if(isset($_POST['submit'])){
			echo '<div>
			<img src="images/upload/frames/fram.jpeg" alt="Image Not Available" style="width: 216px;height: 269px;position: relative;top: -285px;">
			</div>';
		}
