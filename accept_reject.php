...
<body>
	<div class="banner" id="home">
		<div class="navbar navbar-default w3ls-navbar">
			<div class= "container brand1">
				<a href="admin_home.php" class="navbar-brand w3-logo" style="font-family: 'Oswald', sans-serif;">PICOLEX</a>
	...
	<div class="w3-contact" id="contact">
		...
		<h3 class="center">Permission For Meeting</h3>
    ...
    $selectSQL= "SELECT * FROM admin_notify";
