...
<body>
				...
				<div class="collapse navbar-collapse navHeaderCollapse">
					...
					<div class="agileinfo-social-grids">
						...
						<ul>
							...
							<li><a href="canvas.php"><span>Canvas</span></a></li>
						</ul>
	...
	<div class="w3-contact" id="contact">
		...
		<!--<table align="center" width="80%">
			...
			<tr align="center">
				<td><img src="images/frames/1.png" alt="Image Not Available" style="width:250px;height:300px;"></td>
			</tr>
...
if(isset($_FILES['image'])){
	...
	if(isset($_POST["submit"])) {
		...
		$target_dir = "images/upload/canvas/";
		//$random = 'fream';
	...
	// if everything is ok, try to upload file
		...
		if (move_uploaded_file($tmp, "images/upload/canvas/" . $user.".".$extension[1])) {
   ...
   ?>
		...
		<div id="save"> 
		<img src="images/canvas/5.jpeg" alt="Image Not Available" id="show" style="width:400px;height:400px;">
		
		<?php
		if(isset($_POST['submit'])){
			echo '<div>
			<img src="images/upload/canvas/canvas.jpeg" alt="Image Not Available" style="width: 190px;height: 263px;position: relative;top: -382px;left:55px">
			</div>';
		}
  ...
  <img src="images/frames/1.png" id="mirror" class="canvas__mirror" />
</div>-->
...
if(isset($_POST['payment']))
{
	...
	file_put_contents('images/upload/canvas/'."$rand".".png",$decode);
